...
export default function ChatPage() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: "welcome",
      content: "¡Bienvenido al chat de atención al cliente de Supermercado Universo! ¿En qué podemos ayudarle hoy?",
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (lowerCaseMessage.includes("ayuda") || lowerCaseMessage.includes("ayudar")) {
        ...
        responseContent =
          "Nuestro horario de atención es de lunes a sábados de 8:30 a 13:00 y de 17:00 a 20:00, y domingos de 9:00 a 13:00."
      } else if (
